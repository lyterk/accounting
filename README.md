...
Run that uberjar:
    ...
    $ java -jar target/accounting-0.1.0-SNAPSHOT.jar

If you remove `version` from `build.clj`, the uberjar will become `target/accounting-standalone.jar`.
